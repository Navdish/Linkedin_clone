        ...
        <Box sx={{display:"flex", justifyContent:"space-between", padding:"8px"}}>
            <Box sx={{display:"flex"}}>
                ...
                <Box sx={{marginLeft:"8px"}}>
                    <Typography sx={{fontStyle:"normal", fontWeight:"600", fontSize:"16px", LineHeight:"24px", color:"rgba(0,0,0,0.9)"}}>Sparsh bisht</Typography>
                    <Typography sx={{fontStyle:"normal", fontWeight:"400", fontSize:"14px", LineHeight:"20px", color:"rgba(0,0,0,0.6)"}}>Student Coordinator at CCET</Typography>
                    <Box sx={{display:"flex"}}>
                        <LinkIcon/>
